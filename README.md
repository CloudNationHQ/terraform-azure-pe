...
| :-- | :-- | :-- | :-- |
| `endpoints` | describes storage related configuration | object | yes |
...
| Name | Description |
| :-- | :-- |
| `endpoints` | contains private endpoints |
...
Module is maintained by [these awesome contributors](https://github.com/cloudnationhq/terraform-azure-pe/graphs/contributors).

## License

MIT Licensed. See [LICENSE](https://github.com/cloudnationhq/terraform-azure-pe/blob/main/LICENSE) for full details.
